...
#    BAYSTUDY_DIR = "BayStudy"
    ...
    ZOOPLANKTON_CBMATRIX_FILENAME = "1972-2018CBMatrix.xlsx"
    ZOOPLANKTON_MYSID_FILENAME = "1972-2018MysidMatrix.xlsx"
    ZOOPLANKTON_PUMP_FILENAME = "1972-2018Pump Matrix.xlsx"
